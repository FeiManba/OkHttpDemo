    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_PROGRESS://进度
                ...
                mPoint.setPercentage(progress * 1.0f / mFileLength);
                mPoint.setStatus(Consts.PROGRESS);
            ...
            case MSG_FINISH://完成
                ...
                mTmpFile.renameTo(new File(mPoint.getPath(), mPoint.getName()));//下载完毕后，重命名目标文件名
                resetStutus();
                mPoint.setStatus(Consts.FINISH);
            ...
            case MSG_CANCEL://取消
                ...
                mPoint.setStatus(Consts.CANCEL);
                resetStutus();
